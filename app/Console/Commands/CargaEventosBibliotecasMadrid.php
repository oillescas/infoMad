...
class CargaEventosBibliotecasMadrid extends Command {
	...
	public function fire(){
		$this->comment("Importando Eventos Bibliotecas");
		$eventos = $this->madrid->getEventosBibliotecas();
		$n = 0;
		$u=0;
		...
		$this->comment($n+$u." Eventos recuperados $n nuevas, $u actualizadas");
	}
}
